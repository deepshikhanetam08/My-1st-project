...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("👨‍💻 Developed by: **Deepshikha Netam**")
    st.markdown("🔗 GitHub: [Deepshikha Netam](https://github.com/deepshikhanetam08)")
    st.markdown("🔗 LinkedIn: [Profile](www.linkedin.com/in/deepshikha-netam31-00128533b)")
    st.markdown("---")
